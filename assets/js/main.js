...
class LanguageTranslator {
  ...
  init() {
    ...
    if (toggle) {
      toggle.addEventListener('change', (e) => {
        this.toggleLanguage(e.target.checked);
      });
    }
  }
  ...
  translatePage(targetLang) {
    ...
    const elements = document.querySelectorAll('h1, h2, h3, h4, h5, h6, p, span, a, li, td, th, div[class*="card-text"], div[class*="description"]');
  ...
  translateElement(element, targetLang) {
    ...
    const translations = {
      'fr': {
        ...
        'Contact': 'Contact',
        'Home': 'Home',
        'Apprenti ingénieur informatique': 'Computer Science Engineering Apprentice',
        'Je suis': 'I am',
        'Passionné': 'Passionate',
        'créatif': 'creative',
        'calme': 'calm',
        'optimiste': 'optimistic',
        'En une phrase': 'In one sentence',
        'Tout droits réservés': 'All rights reserved',
        'Vous savez quoi?': 'You know what?',
        'Je suis juste passionné': 'I am just passionate',
        'L\'expérience': 'Experience',
        'est la meilleure façon d\'apprendre': 'is the best way to learn',
        'J\'aime ce que je fais': 'I love what I do'
      },
      'en': {
        ...
        'Contact': 'Contact',
        'Home': 'Home',
        'Computer Science Engineering Apprentice': 'Apprenti ingénieur informatique',
        'I am': 'Je suis',
        ...
        'I am just passionate': 'Je suis juste passionné',
        'Experience': 'L\'expérience',
        'is the best way to learn': 'est la meilleure façon d\'apprendre',
        'I love what I do': 'J\'aime ce que je fais'
      }
    };

    if (translations[targetLang] && translations[targetLang][originalText]) {
      element.textContent = translations[targetLang][originalText];
